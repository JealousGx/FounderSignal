...
type ReportRepository interface {
	...
	GetLatest(ctx context.Context, ideaID uuid.UUID) (*domain.Report, error)
...
func (r *reportRepository) GetLatest(ctx context.Context, ideaID uuid.UUID) (*domain.Report, error) {
